...
import {Card, Input, Button, Typography, Alert, CardHeader} from '@material-tailwind/react';
      ...
      <div className='h-full mt-10'>
        ...
        {userType && (
          <div className='flex justify-center items-center'>
            <Card color='transparent' className='p-6 rounded-lg shadow-xl inset-shadow '>
              ...
              <form onSubmit={handleSubmit} className='mt-8 mb-2 w-80 max-w-screen-lg sm:w-96'>
                <div className='mb-1 flex flex-col gap-7'>
                  <Input
                    ...
                    name='email'
                    variant='standard'
                    label={FrntError && FrntError.email ? FrntError.email : 'Enter Email'}
                  ...
                  <Input
                    icon={
                      eyeOpen ? (
                        <FontAwesomeIcon icon={faEye} onClick={() => setEyeOpen(false)} className='cursor-pointer' />
                      ) : (
                        <FontAwesomeIcon icon={faEyeSlash} onClick={() => setEyeOpen(true)} className='cursor-pointer' />
                      )
                    }
                    ...
                    name='password'
                    variant='standard'
                    label={FrntError && FrntError.password ? FrntError.password : 'Enter Password'}
