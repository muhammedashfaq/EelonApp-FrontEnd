...
const AprovalFilter = ({ acYr, classes, subjects, }) => {
  return (
    <div>
      <div className="flex items-center justify-center mobile:flex-wrap gap-4 p-4 rounded-t-lg  h-auto border-2 bg-gradient-to-r from-emerald-400 to-cyan-400 shadow-inherit">
