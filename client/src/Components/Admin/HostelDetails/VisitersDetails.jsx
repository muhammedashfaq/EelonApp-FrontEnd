...
import AddVisiorModal from "./AddVisiorModal";
const TABLE_HEAD = [
  "#No",
  "Name",
  "Occupant Type",
  ...
  return (
    <div className="m-10">
      <div className=" bg-dark-purple py-2 px-2 rounded-t-md flex  items-center space-x-3">
        <span className="text-white font-normal">Visiters Record</span>
       ...
       <div className=" flex space-x-10 mt-4">
        <div className="relative flex w-full max-w-[24rem]">
          ...
          <Button
            ...
            size="sm"
            color={date ? "gray" : "blue-gray"}
            disabled={!date}
            className="!absolute right-1 top-1 rounded pl-2"
          >
            Search
          </Button>
        </div>
...
<span className="cursor-pointer" onClick={()=>handleUpdateinout(_id )}><Chip color="cyan" value="in/out" /></span>
        ...
        {
  showUpdateModal && <UpdateInOutModal inOutUser={inOutUser} closeModal={OpenModal} setShowUpdateModal={setShowUpdateModal}  />
}
...
export default VisitersDetails;
