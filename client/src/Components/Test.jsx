...
import { Card, Typography, Avatar, Badge } from '@material-tailwind/react';
import 'tailwindcss/tailwind.css';
import Contact from './Staff/Header/Contact';
import Profile from './StudentProfile/Profile';

const studentInfo = {
  // Replace placeholders with generic values or symbols
  schoolName: ' Your School Name',
  name: '‍ Student Name',
  classNameName: ' Grade/classNameName',
  regNo: ' Registration Number',
  photoUrl: 'https://example.com/student-photo.jpg',
};
import StaffHeader from "../Components/Staff/Header/landingPageHeader"
import Students from '../Components/Staff/DashboardComponents/StudentAdmintion/StudentsList'
const Test = () => {
  const { schoolName, name, classNameName: studentclassNameName, regNo, photoUrl } = studentInfo;
          ...
          <div className="px-3 py-3 lg:px-5 lg:pl-3">
             <div className="flex items-center justify-between">
                <div className="flex items-center justify-start">
                   ...
                   <span className="self-center whitespace-nowrap">School+Logo</span>
                   </a>
