  ...
  const deleteBook = async (id, public_id) => {
    try {
      ...
      if (result.isConfirmed) {
        ...
        await axiosPrivate.delete(`/library/books/${id}`, {data: {public_id}});
        Swal.fire({
          title: 'Deleted!',
      ...
      <div className=' m-20'>
        <div className=' w-full h-auto  flex justify-around mb-2 border-2 p-1 rounded-lg shadow-md'>
          ...
          <div className='w-full md:w-80 flex gap-1 '>
            ...
            <Button variant='text' onClick={() => setsearchData()} style={{textTransform: 'none'}}>
              Reset
            </Button>
          </div>
                ...
                <tr>
                  ...
                  <th className='border-b border-blue-gray-100 bg-blue-gray-50 p-4'>
                    <Typography
                      variant='small'
                      onClick={() => {
                        navigate(`${RouteObjects.Bookmanagment}/${paginationData.prev.page}`);
                  ...
                  ? searchData.map((data, index) => {
                      ...
                      return (
                        <tr key={data._id}>
                          ...
                          <td className={classes}>
                            <LibraryEditBooksModal data={data} getBooks={getBooks} GenreList={GenreList} />
                            ...
                            {data?.students?.currentlyIssued ? (
                              ...
                              >
                                <FontAwesomeIcon
                                  ...
                                  icon={faTrash}
                                  color='red'
                                  onClick={() => deleteBook(data._id, data?.coverImage?.public_id)}
                                />
                              </Tooltip>
                            )}
                          </td>
