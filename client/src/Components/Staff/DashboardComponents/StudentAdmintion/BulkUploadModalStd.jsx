...
const BulkUploadModalStd = ({getUsers, page}) => {
  ...
  const handleSubmit = async () => {
    try {
      ...
      const response = await axiosFormdata.post('bulkuploads/student', formData);
  ...
  return (
    <>
      <Button onClick={handleOpen} variant='gradient' color='blue' style={{textTransform: 'none', fontSize: '0.9rem'}}>
        Bulk Uploads
      </Button>
