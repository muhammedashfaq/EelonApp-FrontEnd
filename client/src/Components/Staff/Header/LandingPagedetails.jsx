            ...
            <div className='items-center flex flex-wrap'>
              ...
              <div className='w-full md:w-5/12 ml-auto mr-auto px-4'>
                <div className='md:pr-12'>
                  ...
                  <h3 className='text-3xl font-semibold'>JKKM</h3>
                  <p className='mt-4 text-lg leading-relaxed text-gray-600'>
                    Dr. J.K.K.Munirajahh, a leading Industrialist of Komarapalayam town, Namakkal Dt, Tamil Nadu, India is the Chairman and Managing Trustee of
                    Annai J.K.K.Sampoorani Ammal Charitable Trust. He had his Post Graduate Studies in "Textile Management" renounced Bolton Institute of
                    Technology, Bolton, United Kingtom. He is the Managing Director of Two Textile Spinning Mills, one at Komarapalayam, and another at
                    Tiruchengode
                  </p>
