...
import noimage from "../../../assets/unisexavatar.png";
      ...
      <Menu>
        <MenuHandler>
          <Avatar
            variant="circular"
            alt="UserProfile"
            className="cursor-pointer border-2 border-green-200 hover:border-red-100 hover:border-4 transition-all "
            src={ProfilePic?ProfilePic:noimage}

          />
        </MenuHandler>
        <MenuList>
          <div className="mobile:block Laptop:hidden ipad:hidden Tablet:hidden">
