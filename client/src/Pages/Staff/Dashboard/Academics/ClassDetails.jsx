import {Card, Typography, CardHeader, CardBody, Button, Dialog, Input, Select, Option, Tooltip, IconButton} from '@material-tailwind/react';
...
const ClassDetails = () => {
  ...
  const StdListModalOpen = value => {
    setopenStdListModal(prev => !prev);
    setstdListClsId(value);
  };
    ...
    <div className='w-full'>
      ...
      <div className=' m-20'>
        <div className=' w-full h-auto  flex justify-around mb-2 border-2 p-1 rounded-lg shadow-md'>
          ...
          <div>
            <AddClassModal AcademicYrs={AcademicYrs} getAllClass={getAllClass} />
          </div>
        </div>
              ...
              <thead className=' '>
                <tr>
                  <th className='border-b border-blue-gray-100 bg-blue-gray-50 p-4'>
                    <Typography variant='small' color='blue-gray' className=' text-blue-900 border-l  '>
                      No.
                    </Typography>
                  </th>
                  <th className='border-b border-blue-gray-100 bg-blue-gray-50 p-4'>
                  ...
                  ClassData.map((data, index) => {
                    ...
                    return (
                      <tr key={data._id} className='even:bg-blue-gray-50/50'>
                        ...
                        <td className={classes}>
                          <Typography variant='small' color='blue-gray' className='font-normal'>
                            <Button onClick={() => StdListModalOpen(data?.classId)} variant='outlined' style={{textTransform: 'none'}}>
                              List students
                            </Button>
                          </Typography>
                        </td>
                        ...
                        <td className={classes}>
                          <Typography variant='small' color='blue-gray' className='font-normal'>
                            <div>
                              <IconButton onClick={() => deleteClass(data?._id)} variant='text'>
                                <FontAwesomeIcon icon={faTrash} size='xl' className='cursor-pointer' />
                              </IconButton>
                            </div>
                          </Typography>
                        </td>
      ...
      <StudentListModal setopenStdListModal={setopenStdListModal} openStdListModal={openStdListModal} classId={stdListClsId} />
