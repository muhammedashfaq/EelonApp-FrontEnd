	...
	<div className="p-6 space-y-8">
		<header className="container flex items-center justify-between h-16 px-4 mx-auto rounded dark:bg-gray-900">
			<a rel="noopener noreferrer" href="#" aria-label="Homepage">
				<svg xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 32 32" className="w-6 h-6 dark:text-violet-400">
			...
			<div className="items-center hidden space-x-8 lg:flex">
				...
				<button className="px-4 py-2 rounded-md dark:bg-violet-400 dark:text-gray-900">Sign up</button>
			</div>
		...
		<footer>
			<div className="container flex justify-between p-6 mx-auto lg:p-8 dark:bg-gray-900">
				...
				<div className="flex space-x-2">
					<a aria-label="Email" rel="noopener noreferrer" href="#" className="flex items-center justify-center dark:text-gray-400">
						<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor" className="w-5 h-5">
							<path d="M2.003 5.884L10 9.882l7.997-3.998A2 2 0 0016 4H4a2 2 0 00-1.997 1.884z"></path>
							<path d="M18 8.118l-8 4-8-4V14a2 2 0 002 2h12a2 2 0 002-2V8.118z"></path>
						</svg>
					</a>
					<a aria-label="Twitter" rel="noopener noreferrer" href="#" className="flex items-center justify-center dark:text-gray-400">
					...
					<a aria-label="Github" rel="noopener noreferrer" href="#" className="flex items-center justify-center dark:text-gray-400">
	...
	<div className="container flex flex-col justify-center p-6 mx-auto sm:py-12 lg:py-24 lg:flex-row lg:justify-between">
		<div className="flex flex-col justify-center p-6 text-center rounded-sm lg:max-w-md xl:max-w-lg lg:text-left">
			<h1 className="text-5xl font-bold leadi sm:text-6xl">Ac mattis
				<span className="text-amber-600">senectus</span>erat pharetra
			</h1>
			<p className="mt-6 mb-8 text-lg sm:mb-12">Dictum aliquam porta in condimentum ac integer
				<br  className="hidden md:inline lg:hidden" />turpis pulvinar, est scelerisque ligula sem
			</p>
			<div className="flex flex-col space-y-4 sm:items-center sm:justify-center sm:flex-row sm:space-y-0 sm:space-x-4 lg:justify-start">
				<a rel="noopener noreferrer" href="#" className="px-8 py-3 text-lg font-semibold rounded bg-amber-600 text-gray-50">Suspendisse</a>
